...
const enTranslations = {
  ...
  moveUp: 'Move Up (Q key)',
  moveDown: 'Move Down (E key)',
  lookUp: 'Look Up',
  lookDown: 'Look Down',
  turnLeft: 'Turn Left',
  turnRight: 'Turn Right',
  normalSpeed: 'Normal Speed (x1)',
  ...
  addPoint: 'Add Point',
  loadingPoints: 'Loading points from DPAL...',
  // Settings panel
  aspect: 'Aspect',
  system: 'System',
  dark: 'Dark',
...
const jaTranslations = {
  ...
  positionControls: 'ポジションコントロール',
  rotationControls: '回転コントロール',
  movementSpeed: '移動速度',
  moveForward: '前進',
  moveBackward: '後退',
  moveLeft: '左移動',
  ...
  pointList: 'ポイントリスト',
  addPoint: 'ポイント追加',
  loadingPoints: 'DPALからポイントを読み込み中...',
  // Settings panel
  aspect: '外観',
  system: 'システム',
  dark: 'ダーク',
